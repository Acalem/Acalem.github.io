...
(function() {
    ...
    PPT.scenarios.classic = {
        ...
        // Goals/Challenges
        goals: [
            { name: 'Bronze',   guests: 100,  reward: 500 },
            { name: 'Silver',   guests: 200,  reward: 1000 },
            { name: 'Gold',     guests: 400,  reward: 1500 },
            { name: 'Platinum', guests: 800,  reward: 2500 },
            { name: 'Diamond',  guests: 1600, reward: 4000 }
        ],
        ...
        buildings: {
            ...
            'pirate-ship':       { cost: 2800,  run: 370,  cat: 'ride',    name: 'Pirate Ship',       unlock: 'Bronze' },
            'observation-tower': { cost: 3200,  run: 390,  cat: 'ride',    name: 'Observation Tower', unlock: 'Silver' },
            ...
            'hyper-coaster':   { cost: 12000, run: 705,  cat: 'coaster', size: 2, name: 'Hyper Coaster',  unlock: 'Gold' },
            'giga-coaster':    { cost: 15000, run: 785,  cat: 'coaster', size: 2, name: 'Giga Coaster',   unlock: 'Platinum' },
        ...
        // Economy formulas
        economy: {
            guestEntryFee: 13,           // € per guest entering (was 10)
